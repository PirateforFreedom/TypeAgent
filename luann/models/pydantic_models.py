...
from constants import DEFAULT_HUMAN, DEFAULT_PERSONA,DEFAULT_SYSTEMPROMPT
...
class ToolModel(SQLModel, table=True):
    ...
    user_id: Optional[uuid.UUID] = Field(..., description="The unique identifier of the user associated with the tools.")
    
    module: Optional[str] = Field(None, description="The module of the function.")
    


    user_status: Optional[str] = Field(..., description="The user status.")
...
class AgentStateModel(BaseModel):
    ...
    type_agent:Optional[str] = Field(..., description="The type agent.")
    ...
    # preset information
    preset_id: uuid.UUID = Field(..., description="The unique identifier of the user associated with the agent.")
    persona_memory: str = Field(..., description="The persona used by the agent.")
    human_memory: str = Field(..., description="The human used by the agent.")
    # functions_schema: Optional[List[Dict]] = Field(None, description="The functions schema used by the agent.")

    # llm informationLLMConfig
...
class SystemPromptModel(SQLModel, table=True):
    # gpt_system.get_system_text(DEFAULT_SYSTEMPROMPT),
    text: str = Field(default=gpt_system.get_system_text(DEFAULT_SYSTEMPROMPT), description="The system prompt.")
    name: str = Field(..., description="The name of the system prompt.")
    id: uuid.UUID = Field(default_factory=uuid.uuid4, description="The unique identifier of the system prompt.", primary_key=True)
    user_id: Optional[uuid.UUID] = Field(..., description="The unique identifier of the user associated with the system prompt.")
    user_status: Optional[str] = Field(..., description="The user status.")
...
class SourceModel(SQLModel, table=True):
    ...
    embedding_model: Optional[str] = Field(..., description="The embedding model.")
...
class PassageModel(SQLModel, table=True):
    user_id:uuid.UUID= Field(None, description="The unique identifier of the user associated with the passage.")
    ...
    embedding: Optional[List[float]]= Field(sa_column=Column(JSON), description="The embedding of the passage.")
    embedding_model: Optional[str] = Field(..., description="The embedding model.")
    ...
    metadata_: Optional[dict] = Field({},sa_column=Column(JSON), description="The metadata of the PassageModel.")
    user_status: Optional[str] = Field(..., description="The user status.")
...
class DocumentModel(SQLModel, table=True):
    ...
    metadata_: Optional[dict] = Field({},sa_column=Column(JSON), description="The metadata of the document.")
    user_status: Optional[str] = Field(..., description="The user status.")

class RecallMemoryModel(SQLModel, table=True):
    user_id: uuid.UUID = Field(..., description="The unique identifier of the user associated with the recall memory.")
    agent_id: uuid.UUID = Field(..., description="The unique identifier of the user associated with the agent.")
    role: str = Field(..., description="The role of recall memory.")
    text: Optional[str] = Field(..., description="The text of recall memory.")
    model:  Optional[str] = Field(..., description="The model of recall memory.")
    name:  Optional[str] = Field(..., description="The name of recall memory.")
    tool_calls: Optional[List[dict]]= Field(None,sa_column=Column(JSON), description="The tool calls  of the memory.")
    tool_call_id: Optional[str] = Field(None, description="The unique identifier tool_call_id of the user associated with the agent.")
    id: uuid.UUID = Field(default_factory=uuid.uuid4, description="The unique identifier of the recall memory.", primary_key=True)
    embedding: Optional[List[float]]= Field(None,sa_column=Column(JSON), description="The embedding of the passage.")
    embedding_model: Optional[str] = Field(..., description="The embedding model.")
    embedding_dim: Optional[str] = Field(..., description="The embedding model.")
    created_at: datetime = Field(default_factory=get_utc_time, description="The unix timestamp of when the source was created.")
    user_status: Optional[str] = Field(..., description="The user status.")
class OptionState(str, Enum):
    ...
    NO = "no"
    DEFAULT = "default"
class TypeAgentUsageStatistics(BaseModel):
    completion_tokens: int
    prompt_tokens: int
    total_tokens: int
    step_count: int
class ArchivalMemoryModel(SQLModel, table=True):
    user_id: uuid.UUID = Field(..., description="The unique identifier of the user associated with the recall memory.")
    agent_id: uuid.UUID = Field(..., description="The unique identifier of the user associated with the agent.")
    # role: str = Field(..., description="The role of recall memory.")
    text: Optional[str] = Field(..., description="The text of recall memory.")
    # model:  Optional[str] = Field(..., description="The model of recall memory.")
    # name:  Optional[str] = Field(..., description="The name of recall memory.")
    # tool_calls: str = Field(..., description="The tool_calls of the recall memory.")
    # tool_call_id: str = Field(..., description="The unique identifier tool_call_id of the user associated with the agent.")
    id: uuid.UUID = Field(default_factory=uuid.uuid4, description="The unique identifier of the recall memory.", primary_key=True)
    embedding: Optional[List[float]]= Field(sa_column=Column(JSON), description="The embedding of the passage.")
    embedding_model: Optional[str] = Field(..., description="The embedding model.")
    # embedding_dim: Optional[str] = Field(..., description="The embedding model.")
