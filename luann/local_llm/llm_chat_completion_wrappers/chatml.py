...
from local_llm.json_parser import clean_json
from local_llm.llm_chat_completion_wrappers.wrapper_base import (
...
class ChatMLInnerMonologueWrapper(LLMChatCompletionWrapper):
    ...
    def _clean_function_args(self, function_name, function_args):
        """Some basic typeagent-specific cleaning of function args"""
