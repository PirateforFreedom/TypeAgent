...
from local_llm.settings.settings import get_completions_settings
from local_llm.utils import post_json_auth_request
    ...
    settings.update(
        {
            ...
            # In typeagent we handle this ourselves, so this should be disabled
