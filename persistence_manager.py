...
from memory import BaseRecallMemory, EmbeddingArchivalMemory,EmbeddingKnoledgeBase
...
class LocalStateManager(PersistenceManager):
    ...
    knowledge_base_cls = EmbeddingArchivalMemory
    ...
    def __init__(self, agent_state: AgentState):
        ...
        self.knowledge_base = EmbeddingKnoledgeBase(agent_state)
