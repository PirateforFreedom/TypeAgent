...
class CreateThreadRequest(BaseModel):
    ...
    # typeagent-only
    assistant_name: Optional[str] = Field(None, description="The name of the assistant (i.e. typeagent preset)")
...
def setup_openai_assistant_router(server: SyncServer, interface: QueuingInterface):
    ...
    # create assistant (typeagent agent)
    ...
    def list_assistants(
        ...
        # TODO: implement list assistants (i.e. list available typeagent presets)
