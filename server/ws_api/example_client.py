...
import server.ws_api.protocol as protocol
from constants import JSON_ENSURE_ASCII, JSON_LOADS_STRICT
from server.constants import WS_CLIENT_TIMEOUT, WS_DEFAULT_PORT
from server.utils import condition_to_stop_receiving, print_server_response
...
async def basic_cli_client():
    """Basic example of a typeagent CLI client that connects to a typeagent server.py process via WebSockets
